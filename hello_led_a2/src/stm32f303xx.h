...
// stm32f303xx.h
//
// 20-Aug 2024 (Scott Pavetti)
// Removed duplicated entries, cleaned up a few macros, reorganized structure
// See TODO's for some suspicious items that need clarification from the datasheet.


#include <stdint.h>

// Helper macros that define bitmasks up to 32 bit integers
#define BIT0 (1 << 0)
#define BIT1 (1 << 1)
#define BIT2 (1 << 2)
#define BIT3 (1 << 3)
...
// DMA2 (5 channels)
// TODO: Why are these numbered to 7 instead of 5?
